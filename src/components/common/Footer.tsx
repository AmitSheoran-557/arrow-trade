            ...
            <div className="container mx-auto px-4 pt-[60px] pb-20">
                ...
                <div className='flex lg:gap-6 gap-5'>
                    {SOCIAL_LINKS_LIST.map((item, index) => (
                        <Link key={index} href="{item.link}" className='flex items-center justify-center rounded-full w-9 h-9'>
