...
export const NAV_LINKS_LIST :{ link: string; title: string; dropdown?: { link: string; title: string; }[] }[] = [
  { link: "/", title: "Home" },
...
export const SOCIAL_LINKS_LIST = [
  { link: "http", alt: "facebook-icon", image: "/assets/images/webp/facebook-logo.webp" },
  { link: "http", alt: "instagram-icon", image: "/assets/images/webp/instagram-logo.webp" },
  { link: "http", alt: "youtube-icon", image: "/assets/images/webp/youtube-logo.webp" },
  { link: "http", alt: "music-icon", image: "/assets/images/webp/music-logo.webp" },
  { link: "http", alt: "twitter-icon", image: "/assets/images/webp/twitter-logo.webp" },
  { link: "http", alt: "linkedin-icon", image: "/assets/images/webp/linkdeIn-logo.png" },
];
